...
export default {
  ...
  data () {
    ...
    created:function(){
        ...
        dataShow.financeRepay(detail,'detail/findCapitalProRepStatis',this);
        if($(window).width()<768){
    ...
    methods: {
        ...
        exportData () {
            ...
            window.open(this.$store.getters.httpUrl + '/export/exportCapitalProRepStatis?capitalPro='+pro+'&statisticType=' + type);
        },
        financeRepay(data){
            this.data1=[];
            if(data==null){
